...
// EMAIL MESSAGE
// *************
define('EMAIL_TO', 'madomfeh@gmail.com');
define('EMAIL_TO_NAME', 'michael');
...
define('EMAIL_FROM', 'madomfeh@gmail.com');
define('EMAIL_FROM_NAME', 'testmike');

define('EMAIL_REPLY_TO', 'FIELD:Email');
define('EMAIL_REPLY_TO_NAME', 'FIELD:Email');

define('EMAIL_SUBJECT_BEFORE', 'test1');
define('EMAIL_SUBJECT', "New Contact Form Message");
define('EMAIL_SUBJECT_AFTER', '1test');
